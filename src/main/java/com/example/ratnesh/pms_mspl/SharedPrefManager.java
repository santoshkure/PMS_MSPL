...
public class SharedPrefManager {
    ...
    private static final String KEY_PARTYID = "keypartyid";
    ...
    public void userLogin(User user) {
        SharedPreferences sharedPreferences = mCtx.getSharedPreferences(SHARED_PREF_NAME, Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putString(KEY_USERNAME, user.getUserLoginId());
        editor.putString(KEY_USERID, user.getUserId());
        editor.putString(KEY_PARTYID, user.getPartyId());
        editor.apply();
    }
    ...
    public User getUser() {
        ...
        return new User(
                ...
                sharedPreferences.getString(KEY_PARTYID, null)
        );
    }
