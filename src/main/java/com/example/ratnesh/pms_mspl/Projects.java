    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent add_project_intent = new Intent(Projects.this, AddProject.class);
                        ...
                        try {
                            ...
                            if (!obj.getBoolean("error")) {
                                ...
                                for (int i = 0; i <= projectList.length(); i++) {
                                    ...
                                    row2 = new TableRow(Projects.this);
                                    row2.setBackground(getResources().getDrawable(R.drawable.border));
                                    row2.setLayoutParams(lp);


                                    projectNameTextView = new TextView(Projects.this);
                                    ...
                                    row2.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View view) {
                                            finish();
                                            Intent sendProjectId = new Intent(Projects.this, ProjectDetails.class);
